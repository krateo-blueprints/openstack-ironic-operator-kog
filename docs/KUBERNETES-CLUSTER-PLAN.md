---
type: Architecture
title: kubernetes-cluster blueprint — implementation plan
description: Source-of-truth roadmap for hardening and extending the kubernetes-cluster chart — the milestones that turn Ironic-provisioned blades into a kubeadm-bootstrapped Kubernetes cluster.
resource: oci://ghcr.io/krateo-blueprints/charts/baremetal-host
tags: [ironic, kubernetes-cluster, roadmap, architecture, kubeadm]
